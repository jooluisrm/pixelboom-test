...
export const ButtonLi = ({ text, active }: Props) => {
    return (
        <li className={`w-full cursor-pointer text-[14px] h-[40px] text-start flex items-center gap-3 py-2 px-3 rounded-lg list-none ${active && "bg-[#102822] text-[#F4F4F5] rounded-full"} `}>
            {
